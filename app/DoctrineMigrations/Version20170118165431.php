 ...
 */
class Version20170118165431 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE project ADD online TINYINT(1) DEFAULT NULL, ADD draft TINYINT(1) DEFAULT NULL, DROP settings');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE project ADD settings TINYTEXT NOT NULL COLLATE utf8_unicode_ci, DROP online, DROP draft');
